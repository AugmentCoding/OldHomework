...
#include <string>
#include <iomanip>
#include "GeneralHashFunctions.h"	//Now contains random string generator
...
int main(int argc, char* argv[])
{
   ...
   for(i = 0; i < numTrial; i++){
        ...
        //Assigns string key to randomly generated string from GeneralHashFunctions.cpp
