 ...
 * Created on April 13th, 2018, 3:22 PM
...
class LinkedList{
    ...
    public:
        ...
        void printOperations();  //Displays the number of operations
};
...
void LinkedList<T>::addLst(const T &data){
    ...
    do{
        ...
        equal++;
        equal++; //For setting the pointer equal to the next link in the line below
