...
class LinkList{
    ...
    public:
        ...
        void prntLstReverse(){
            ...
            std::cout<<"\nThe End of the List"<<std::endl;
            while(next!=NULL){
                std::cout<<next->data<<std::endl; //Print the contents of the link
                next=next->prev;     //Go to the next link in the list
            };         //Loop until reaching the end
            std::cout<<"The Beginning of the List"<<std::endl<<std::endl;
        }
        ...
        void   addLst(T data){
            Link<T> *last=endLst();  //Find the last link
